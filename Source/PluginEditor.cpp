      ...
      playButtonAttachment (processorRef.getState (), "play", playButton)
{
    ...
    frequencySlider.setTextBoxStyle (juce::Slider::TextBoxBelow, true, 100,
                                     50);
...
NinjuAudioProcessorEditor::resized ()
{
    ...
    frequencyLabel.setBounds (getWidth () / 2 - 50, getHeight () / 2 - 120,
                              100, 20);
    frequencySlider.setBounds (getWidth () / 2 - 50, getHeight () / 2 - 100,
                               100, 200);
    playButton.setBounds (getWidth () / 2 - 50, getHeight () / 2 + 120, 100,
                          20);
}
